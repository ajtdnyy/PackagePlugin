 ...
 * for the various artifacts generated by abator. 
 * 
 * @author Jeff Butler
 */
public interface CommentGenerator {
     ...
     *  JavaDoc tag "@abatorgenerated" to the comment.  Without this
     ...
     * If you run Abator repeatedly, you will only retain the comment
     ...
     * Abator repeatedly, you will only retain the comment from the
     * initial run.<p>
     * 
     * The default implementation does nothing.
     * 
